...
const stats = [
  { label: "Total Orders",   value: "12",       icon: ShoppingBag, color: "#6366f1", bg: "#eef2ff" },
  { label: "Wishlist Items", value: "8",         icon: Heart,       color: "#ec4899", bg: "#fdf2f8" },
  { label: "Total Spent",    value: "₦284,500",  icon: TrendingUp,  color: "#22c55e", bg: "#f0fdf4" },
  { label: "Reviews Given",  value: "5",         icon: Star,        color: "#f59e0b", bg: "#fffbeb" },
]
    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        <p className="text-xs font-bold uppercase tracking-widest mb-1"
          style={{ color: "var(--color-brand-600)" }}>My Account</p>
      ...
      <div className="rounded-2xl border overflow-hidden"
        ...
        <div className="flex items-center justify-between p-4 sm:p-5 border-b"
          ...
          <h2 className="font-black text-base sm:text-lg"
            style={{ color: "var(--foreground)" }}>Recent Orders</h2>
          <Link href="/dashboard/orders"
            className="text-sm font-semibold hover:opacity-70"
            style={{ color: "var(--color-brand-600)" }}>View all →</Link>
        </div>
