...
const orders = [
  {
    ...
    items: [
      { name: "Premium Ankara Fabric (6 Yards)", qty: 2, price: 8500 },
    ],
  ...
  },
  {
    ...
    items: [
      { name: "Tecno Camon 30 Pro 5G", qty: 1, price: 189000 },
    ],
  ...
  },
  {
    ...
    items: [
      { name: "JBL Flip 6 Bluetooth Speaker", qty: 1, price: 52000 },
    ],
  ...
  },
  {
    ...
    items: [
      { name: "Pure Unrefined Shea Butter 500g", qty: 3, price: 3500 },
    ],
              ...
              <div className="flex flex-wrap items-center gap-4">
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider mb-0.5"
                    style={{ color: "var(--muted-foreground)" }}>Order ID</p>
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider mb-0.5"
                    style={{ color: "var(--muted-foreground)" }}>Date</p>
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider mb-0.5"
                    style={{ color: "var(--muted-foreground)" }}>Total</p>
