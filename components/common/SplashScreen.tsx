        ...
        {showSplash && (
          ...
          >
            <div className="relative flex items-center justify-center w-40 h-40">
              <motion.svg className="absolute inset-0 w-full h-full" viewBox="0 0 160 160" fill="none"
                animate={{ rotate: 360 }} transition={{ duration: 2, ease: "linear", repeat: Infinity }}>
                <circle cx="80" cy="80" r="72" stroke="url(#gradOuter)" strokeWidth="3"
                  strokeLinecap="round" strokeDasharray="120 332" />
                <defs>
              ...
              <motion.svg className="absolute inset-0 w-full h-full" viewBox="0 0 160 160" fill="none"
                ...
                <circle cx="80" cy="80" r="58" stroke="url(#gradInner)" strokeWidth="2"
                  strokeLinecap="round" strokeDasharray="60 304" />
                <defs>
              ...
              >
                <Image src="/buynow-logo.png" alt="BuyNow Marketplace"
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
              ...
              <p className="text-white font-black text-2xl tracking-tight">BuyNow</p>
              <p className="text-sm font-medium tracking-widest uppercase"
                style={{ color: "#6366f1" }}>Marketplace</p>
            </motion.div>
