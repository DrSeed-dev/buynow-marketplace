  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          <div className="rounded-2xl border shadow-2xl p-5 flex flex-col gap-4"
            ...
            <p className="text-sm leading-relaxed" style={{ color: "var(--muted-foreground)" }}>
              ...
              <Link href="/cookies" className="font-semibold hover:opacity-80"
            ...
            <div className="flex gap-2">
              <button onClick={acceptEssential}
                className="flex-1 h-10 rounded-xl text-sm font-bold border-2 transition-all hover:opacity-80"
