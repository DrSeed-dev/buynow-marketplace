...
export function CartDrawer() {
  ...
  // Portal only works after the component mounts on the client
      ...
      >
        ...
        {items.length === 0 ? (
          ...
          <>
            ...
            {/* Footer */}
            <div
              className="px-6 py-5 border-t flex flex-col gap-4 flex-shrink-0"
              style={{ borderColor: "var(--border)" }}
            >
  ...
  return (
    <>
      {/* Cart trigger button — stays in Navbar */}
      <button
      ...
      {/* Portal — renders drawer directly into document.body,
          completely outside the Navbar DOM tree */}
